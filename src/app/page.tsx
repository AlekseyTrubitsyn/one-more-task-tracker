...
export default async function Home() {
  ...
  return (
    <div className="grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)] page-with-header">
      <main className="flex flex-col row-start-2 items-center sm:items-start text-zinc-200">
        ...
        <h2 className="text-l mt-0 mb-12 text-zinc-500">
          just a sandbox created to check out some technologies
        </h2>
        ...
        <ol className="list-inside list-decimal text-sm text-center sm:text-left font-[family-name:var(--font-geist-mono)] flex flex-col gap-1">
          <li className="line-through">
            User auth by Clerk, init db by Neon & Drizzle.
          </li>
          <li>
          ...
          <li>
            Projects combine boards, and users can create and be assigned to
            them.
          </li>
